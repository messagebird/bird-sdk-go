...
// callerRule is one Bird-Caller detection rule; the ordered table below is
// walked by detectCaller (see caller-detection.yaml for the model).
...
var callerBooleanishSkip = map[string]struct{}{
	"1":     {},
	"0":     {},
	"true":  {},
	"false": {},
