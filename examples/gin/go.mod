// Framework composite (ADR-0054): the Gin handler example lives in its own
...
module github.com/messagebird/bird-sdk-go/examples/gin
...
replace github.com/messagebird/bird-sdk-go => ../..
